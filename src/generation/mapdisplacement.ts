export default class HeightMap {
  ...
  constructor(
    ...
    this.map = Array(mapDimension + 1)
      .fill(0)
      .map((el) => new Array(mapDimension + 1).fill(0).map(() => 0));
  ...
  startDisplacement = () => {
    ...
    map[mapDimension / 2][mapDimension / 2] =
      ...
      map[0][mapDimension] +
      map[mapDimension][0] +
      map[mapDimension][mapDimension] / 4;
  ...
  midpointDisplacment = (plot: number) => {
